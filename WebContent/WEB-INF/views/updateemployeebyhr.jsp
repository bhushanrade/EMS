				...
				<div class="row">
					<div class="col-sm-5">
						<div class="basic-login">
							<form:form modelAttribute="updateModelHr" method="post" role="form" >
								...
								<div class="form-group">
		        				 	...
		        				 	<form:input type="date" path="dateOfJoining" class="form-control" required="required" placeholder="date of joining"  />
