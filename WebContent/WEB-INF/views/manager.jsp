...
<div align="center">
<h4>Welcome Manager&nbsp;${sessionScope.employee.firstname}&nbsp;${sessionScope.employee.lastname}</h4>
</div>
<br><div align="center"><a href="../mgraction/update">Update Profile</a></div>
	 <div class="section">
	    	<div class="container">
	...
	<div class="row">
		<div class="col-sm-12 col-md-12">
			<table class="table">
				...
				<c:forEach var="employeeList" items="${requestScope.empList}">
					<tr>
						...
						<td><a href="<spring:url value='../mgraction/updateEmployee/${employeeList.empId}'/>">Update Employee</a></td>
						<td><a href="<spring:url value='../mgraction/changeDepartmentByMgr/${employeeList.empId}'/>">Change Department</a></td>
					</tr>
				</c:forEach>
			</table>
		</div>
