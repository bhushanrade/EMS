				...
				<div class="row">
					<div class="col-sm-5">
						<div class="basic-login">
							<form:form modelAttribute="updateModel" method="post" role="form" >
								...
								<div class="form-group">
		        				 	...
		        				 	<form:input type="date" path="dateOfBirth" class="form-control" required="required" placeholder="date of birth"readonly="true" />		        				 
								</div>
								<div class="form-group">
								 ...
								 <div class="form-group">
									...
									<form:input type="password" path="password" class="form-control" required="required" placeholder="password" readonly="true" />
							</div>
							<div class="form-group">
					        		<label for="login-password"><i class="icon-lock"></i> <b>Confirm Password</b></label>
									<form:input type="password" path="confirmPassword" class="form-control" required="required" placeholder="confirm password" readonly="true" />
							</div>
							<div class="form-group">
