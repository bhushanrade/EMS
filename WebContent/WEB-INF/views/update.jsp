				...
				<div class="row">
					<div class="col-sm-5">
						<div class="basic-login">
							<form:form modelAttribute="updateSelfInfo" method="post" role="form" >
							...
							<form:input  path="department.deptName" class="form-control" readonly="true" />
							</div>
							<div class="form-group">
							...
							<div class="form-group">
		        				 	...
		        				 	<form:input path="role" class="form-control" required="required" placeholder="role" readonly="true" />
							...
							<label for="login-username"><i class="icon-user"></i> <b>City</b></label>
									<form:select path="city" class="form-control">
										<option value="Delhi" value="Delhi">Delhi</option>
							...
							<label for="login-username"><i class="icon-user"></i> <b>State</b></label>
									<form:select path="state" class="form-control">
										<option value="Uttar Pradesh" value="Uttar Pradesh">Uttar Pradesh</option>
							...
							<label for="login-username"><i class="icon-user"></i> <b>Country</b></label>
									<form:select path="country" class="form-control">
										<option value="India" value="India">India</option>
